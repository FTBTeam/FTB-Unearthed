...
import dev.ftb.mods.ftbunearthed.item.SuperBrushItem;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> CRUDE_BRUSH
            = ITEMS.register("crude_brush", () -> new BrushItem(new Item.Properties()
            .durability(64)
            .stacksTo(1)));
    public static final DeferredItem<Item> REINFORCED_BRUSH
            = ITEMS.register("reinforced_brush", () -> new BrushItem(new Item.Properties()
            .durability(256)
            .stacksTo(1)));
    public static final DeferredItem<Item> UNBREAKABLE_BRUSH
            = ITEMS.register("unbreakable_brush", () -> new BrushItem(new Item.Properties()
            .component(DataComponents.UNBREAKABLE, new Unbreakable(false))
            .rarity(Rarity.RARE)
            .stacksTo(1)));
    public static final DeferredItem<Item> SUPER_BRUSH
            = ITEMS.register("super_brush", () -> new SuperBrushItem(new Item.Properties()
            .component(DataComponents.UNBREAKABLE, new Unbreakable(false))
            .component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true)
            .component(ModDataComponents.SUPER_BRUSH, Unit.INSTANCE)
            .rarity(Rarity.EPIC)
            .stacksTo(1)));
    ...
    public static final DeferredItem<EchoEncoder> ECHO_ENCODER
            ...
            .stacksTo(1)
            .component(ModDataComponents.ENCODER_USES, 0)));
