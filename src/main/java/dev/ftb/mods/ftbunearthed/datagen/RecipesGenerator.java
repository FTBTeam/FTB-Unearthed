...
public class RecipesGenerator extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput output) {
        new UneartherRecipeBuilder(Ingredient.of(Items.NAME_TAG), Ingredient.of(Items.BRUSH), List.of(
                new ItemWithChance(Items.DIAMOND.getDefaultInstance(), 0.1),
                new ItemWithChance(Items.AMETHYST_SHARD.getDefaultInstance(), 0.1),
                new ItemWithChance(Items.EMERALD.getDefaultInstance(), 0.1),
                new ItemWithChance(Items.LAPIS_LAZULI.getDefaultInstance(), 0.2)
        )).saveTest(output, FTBUnearthed.id("name_tag_and_brush"));
    }
}
